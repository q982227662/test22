...
var fetchJsonp = require("fetch-jsonp"); // Get searchform element 
...
function showMusic(musics) {
  console.log(musics);
  var results = document.querySelector("#results"); //clear results
